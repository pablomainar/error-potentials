%% This script is the final preprocessing for passive recordings
...
file_name = strcat('markers_',subject,'_p.mat'); % Name of the markers file
...
% Translate trigger values so that they match to the active case
triggersValue(find(triggersValue==53)) = 51;
triggersValue(find(triggersValue==55)) = 52;
triggersValue(find(triggersValue==57)) = 53;
triggersValue(find(triggersValue==103)) = 101;
triggersValue(find(triggersValue==105)) = 102;
triggersValue(find(triggersValue==107)) = 103;
